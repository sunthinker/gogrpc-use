...
type UserInfoResponse struct {
	...
	Dept     *string  `protobuf:"bytes,4,opt,name=dept,proto3,oneof" json:"dept,omitempty"` //optional可选字段，会生成指针类型*string
	Roles    []string `protobuf:"bytes,5,rep,name=roles,proto3" json:"roles,omitempty"`     //repeated可选字段，会生成切片类型[]string
}
...
func (x *UserInfoResponse) GetDept() string {
	if x != nil && x.Dept != nil {
		return *x.Dept
	}
	return ""
...
var file_userinfo_proto_rawDesc = []byte{
	...
	0x02, 0x69, 0x64, 0x22, 0x88, 0x01, 0x0a, 0x10, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f,
	...
	0x05, 0x52, 0x03, 0x61, 0x67, 0x65, 0x12, 0x17, 0x0a, 0x04, 0x64, 0x65, 0x70, 0x74, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x04, 0x64, 0x65, 0x70, 0x74, 0x88, 0x01, 0x01, 0x12,
	0x14, 0x0a, 0x05, 0x72, 0x6f, 0x6c, 0x65, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05,
	0x72, 0x6f, 0x6c, 0x65, 0x73, 0x42, 0x07, 0x0a, 0x05, 0x5f, 0x64, 0x65, 0x70, 0x74, 0x32, 0x45,
	0x0a, 0x0f, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x12, 0x32, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x2f, 0x70, 0x62, 0x3b, 0x70, 0x62,
...
var file_userinfo_proto_depIdxs = []int32{
	0, // 0: UserInfoService.GetUserInfo:input_type -> UserInfoRequest
	1, // 1: UserInfoService.GetUserInfo:output_type -> UserInfoResponse
